...
from api.app.ai.rubric_proposer import propose_new_failure_class, propose_additional_criterion
from api.app.ai.runbook_proposer import propose_runbook_update
from api.app.models import Rubric, RubricCriterion, StageOutcome
from api.app.rubric_evaluator import CriterionResult, EvaluationResult, evaluate_rubric
...
class TestActionReceipt:
    def test_valid_action_receipt(self):
        from api.app.models import ActionReceipt, ActionResult
    ...
    def test_action_receipt_requires_fields(self):
        from api.app.models import ActionReceipt
