...
class TestSchemaValidatorUtility:
    def test_validate_evidence_valid(self):
        from api.app.schema_validator import validate_evidence
        data = {
            "evidence_id": "ev-001",
            "run_id": "test-001",
            "stage_id": "ns",
    ...
    def test_validate_evidence_invalid(self):
        from api.app.schema_validator import validate_evidence, SchemaValidationError
        data = {"evidence_id": "ev-001"}
        with pytest.raises(SchemaValidationError):
            validate_evidence(data)

    def test_validate_run_valid(self):
        from api.app.schema_validator import validate_run
        data = {
            "run_id": "test-001",
            "demo_id": "demo",
            "namespace": "ns",
    ...
    def test_validate_against_schema_generic(self):
        from api.app.schema_validator import validate_against_schema, SchemaValidationError
