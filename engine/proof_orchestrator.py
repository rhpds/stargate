...
def run_proof_cycle(
    ...
    detect_checks = {
        ...
        "sync_failed":             [("get", "events", "SyncFailed|ReconcileFailed|BackOff|Back-off"), ("get", "pods", "CrashLoopBackOff|Error")],
        ...
        "volume_attach_failed":    [("get", "events", "FailedAttachVolume|AttachVolume|FailedMount"), ("get", "pvc", "Pending"), ("get", "pods", "ContainerCreating|Pending")],
